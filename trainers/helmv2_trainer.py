...
class HELMv2PPO(OnPolicyAlgorithm):
    """
    ...
    def __init__(
        ...
        self.policy = HELMv2(env.action_space, self.observation_space.shape, self.config['optimizer'],
                           self.config['learning_rate'], device=self.device).to(self.device)
    ...
    def _setup_model(self) -> None:
        super(HELMv2PPO, self)._setup_model()
